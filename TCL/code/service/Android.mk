...
#[BUGFIX]-Add by TCTNB.Chen Ji,11/14/2013,553538,Wi-Fi Test Mode
ifeq ($(HAVE_WIFI_TEST),true)
LOCAL_CFLAGS += -DHAVE_WIFI_TEST
endif
...
LOCAL_JAVA_LIBRARIES := bouncycastle conscrypt services frameworks_ext
