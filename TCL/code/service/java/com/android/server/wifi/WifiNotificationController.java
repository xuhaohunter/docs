...
final class WifiNotificationController {
     ...
     */
	//add by dashun.liang for PR888817 12/31/2014 begin
    private static final int NUM_SCANS_BEFORE_ACTUALLY_SCANNING = 2; //[BUGFIX#943153][TCT Nanterre] Wi-Fi notification display after turn OFF airplane mode even if AP is saved on the phone
    /**
    ...
    /* PR#956108 - SH SWD4 Connectivity - ming.ren@jrdcom.com 66826 - 20150326 begin
     ...
     private boolean mProductIdol347;
    ...
    WifiNotificationController(Context context, WifiStateMachine wsm) {
        ...
        NOTIFICATION_REPEAT_DELAY_MS = Settings.Global.getInt(context.getContentResolver(),
                Settings.Global.WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY, 300) * 1000l;
        ...
        if (visible) {
            ...
            if (mNotification == null) {
                ...
                /* PR#956108 - SH SWD4 Connectivity - ming.ren@jrdcom.com 66826 - 20150326 begin
                   [BUGFIX] [WiFi] Change sound for "new wifi" */
                if (mProductIdol347) {
                    mNotification.sound = Uri.parse("file:///system/media/audio/wifi_ring/wifi_notification.ogg");
                } else {
                mNotification.defaults = Notification.DEFAULT_SOUND;
                }
                /* PR#956108 - SH SWD4 Connectivity - Ming.Ren - 20150326 end */
               //add by dashun.liang for PR888817 12/31/2014 end
			...
			//add by dashun.liang for PR888817 12/31/2014 begin
            notificationManager.cancelAsUser(null, ICON_NETWORKS_AVAILABLE, UserHandle.OWNER);
        }
