...
public class WifiNative {
    ...
    //[FEATURE]-BEGIN-by TCTNB.Ji.Chen,2014/10/30,FR-736524,Wi-Fi FTM Dev
    public native static boolean testModeStartTx();

    public native static boolean testModeStopTx();

    public native static boolean loadTestModeDriver();

    public native static boolean unloadTestModeDriver();
    ...
    public native static boolean connectTosoftap();
    ...
    public boolean startWpsPbcCommand() {
        return doBooleanCommandNative("WPS_PBC");
    }
