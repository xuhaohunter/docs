...
import android.net.TctExtNetworkUtils;
...
public final class WifiServiceImpl extends IWifiManager.Stub {
    ...
    public void startScan(ScanSettings settings, WorkSource workSource) {
        ...
        Log.i(TAG,  "process " + Binder.getCallingPid() + " request wifi scan");
    ...
    public synchronized boolean setWifiEnabled(boolean enable) {
        ...
        //[BUGFIX]-Add-BEGIN by TCTNB.Zhang Jinbo,10/31/2014,FR736845
        if ((!enable) && (mContext.getResources().getBoolean(com.android.internal.R.bool.def_tctfw_dhcprelease_enable)) 
             && (mWifiController.mNetworkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) ) {
            TctExtNetworkUtils.sendRelease("wlan0");
            //[BUGFIX]-Add-BEGIN by TCTNB.Liu Ruili,02/11/2015,PR905474 Add a delay timer for DHCP release
            try{
                Thread.sleep(100);
            } catch (InterruptedException e) {}
            //[BUGFIX]-Add-END by TCTNB.Liu Ruili
        }
		//[BUGFIX]-Add-END by TCTNB.Zhang Jinbo
...
//[BUGFIX]-Add-BEGIN by TCTNB.Chen Ji,11/03/2014,736524,Wi-Fi FTM dev
//Wi-Fi Test Mode
    public boolean setWifiTestModeStartTx() {
        return mWifiStateMachine.tct_testModeStartTx();
    }

    public boolean setWifiTestModeStopTx() {
        return mWifiStateMachine.tct_testModeStopTx();
    }

    public synchronized boolean setWifiTestModeEnabled(boolean enable) {
        enforceChangePermission();

        int uid = Binder.getCallingUid();

        Slog.d(TAG, "setWifiTestModeEnabled: " + enable + " pid=" + Binder.getCallingPid()
                    + ", uid=" + Binder.getCallingUid());
        ...
        */
        ...
        return mWifiStateMachine.tct_setWifiTestModeEnabled(enable);
    }
//[BUGFIX]-Add-END by TCTNB.Chen Ji
    ...
    public boolean isDualBandSupported() {
        ...
        /*
        //[BUGFIX#900127],TCTSH.xinhua.xia[Wi-Fi]“Wi-Fi Frequency band" should not display,becasue idol3 not support 5GHz. begin
        return mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_wifi_dual_band_support);
        */
        //[BUGFIX#900127],TCTSH.xinhua.xia[Wi-Fi]“Wi-Fi Frequency band" should not display,becasue idol3 not support 5GHz. begin
        return mContext.getResources().getBoolean(com.android.internal.R.bool.def_tctfw_wifi_dual_band_support);
        //[BUGFIX#900127],TCTSH.xinhua.xia[Wi-Fi]“Wi-Fi Frequency band" should not display,becasue idol3 not support 5GHz. end
    }
