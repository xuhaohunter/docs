...
//Wifi sleep policy release dhcp
    ...
    class DeviceActiveState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (msg.what == CMD_DEVICE_IDLE) {
                //[BUGFIX]-Add-BEGIN by TCTNB.Zhang Jinbo,10/31/2014,FR736845,,dhcp release
                if (mContext.getResources().getBoolean(com.android.internal.R.bool.def_tctfw_dhcprelease_enable) 
                       && (mNetworkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED)
                       && (!mLocks.hasLocks())) {
                    log("deviceIdle send dhcp release");
