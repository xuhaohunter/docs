...
//[BUGFIX]-Add-BEGIN by TCTNB.LongNa,11/13/2014,837557,It can't recognise and connect the Chinese AP
#define CONVERT_LINE_LEN 2048
#define CHARSET_CN ("gbk")

//[BUGFIX]-Add-BEGIN by TCTSH.xinhuaxia 1/4/2015 DUT can't connect the AP of chinase name
#include "android_net_wifi_Gbk2Utf.h"
//[BUGFIX]-Add-BEGIN by TCTSH.xinhuaxia
...
static jboolean android_net_wifi_connectTosoftap(JNIEnv* env, jobject)
{
    return (::wifi_connect_to_softap() == 0);
}
...
//[BUGFIX]-Add-BEGIN by TCTNB.Ruili.Liu,09/25/2014,788534,
//Through JNI to define  funtions of loaddriver unloaddriver and startTx.
#ifdef HAVE_WIFI_TEST
static jboolean android_net_wifi_testmode_loaddriver(JNIEnv* env, jobject)
{
    return (::wifi_load_testmode_driver() == 0);
}

static jboolean android_net_wifi_testmode_unloaddriver(JNIEnv* env, jobject)
{
    return (::wifi_unload_testmode_driver() == 0);
}

static jboolean android_net_wifi_testmode_startTx(JNIEnv* env, jobject)
{
    return (::wifi_testmode_starttx() == 0);
}

static jboolean android_net_wifi_testmode_stopTx(JNIEnv* env, jobject)
{
    return (::wifi_testmode_stoptx() == 0);
}
#endif
...
static JNINativeMethod gWifiMethods[] = {
    ...
    //Add WiFi WPS Push Button Feature
    { "connectTosoftap", "()Z",
            (void *)android_net_wifi_connectTosoftap },
    //[FEATTURE]-Add-END by TCTNB.Zhang Jinbo
...
#ifdef HAVE_WIFI_TEST
    {"loadTestModeDriver", "()Z",  (void *)android_net_wifi_testmode_loaddriver },
    {"unloadTestModeDriver", "()Z", (void *)android_net_wifi_testmode_unloaddriver },
    {"testModeStartTx", "()Z", (void *)android_net_wifi_testmode_startTx },
    {"testModeStopTx", "()Z", (void *)android_net_wifi_testmode_stopTx },
#endif
};
