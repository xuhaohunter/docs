...
//[BUGFIX]-MOD BEGIN by TCTNB.Ji.Chen,2015/02/05,PR920048,make a compatibilty with TCL v102 dongle
		p2p_dbg(p2p, "set_ssid_postfix length is more than max ssid_postfix len,make a substring");
		//return -1;
		len = sizeof(p2p->cfg->ssid_postfix);
